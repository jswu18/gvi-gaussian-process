...
\section{GWI Problem Set Up}\label{sec:gwi-problem-set-up}
...
\subsection{Reference Kernel Hyperparameter Tuning}\label{subsec:reference-kernel-hyperparameter-tuning}
