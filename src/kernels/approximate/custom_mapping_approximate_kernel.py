...
class CustomMappingApproximateKernelParameters(CustomMappingKernelParameters):
    pass


class CustomMappingApproximateKernel(CustomMappingKernel):
    """
    ...
    def _calculate_gram(
        ...
        custom_mapping_gram_inducing = super()._calculate_gram(
        ...
        custom_mapping_gram_x1_inducing = super()._calculate_gram(
            parameters=parameters,
            x1=x1,
            x2=self.inducing_points,
        )
        custom_mapping_gram_x2_inducing = super()._calculate_gram(
            parameters=parameters,
            x1=x2,
            x2=self.inducing_points,
        )
        custom_mapping_gram_x1_x2 = super()._calculate_gram(
            parameters=parameters,
            x1=x1,
            x2=x2,
        )
