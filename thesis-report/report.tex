...
To demonstrate our experimentation framework, we learned GWI-GPs and pGVI-GPs for ten regression curves shown in Figure \label{toy-curves}. Each curve has randomly selected segments removed from the training data to visualise an out-of-data (OOD) setting. 

\begin{figure}[h!]
\centering
\begin{minipage}{.19\textwidth}
  \centering
  \includegraphics[width=\linewidth]{experiments/regression/toy_curves/outputs/curve3/tempered-WassersteinRegularisation.png}
  \includegraphics[width=\linewidth]{experiments/regression/toy_curves/outputs/curve3/tempered-WassersteinRegularisation.png}
\end{minipage}%
\begin{minipage}{.19\textwidth}
  \centering
