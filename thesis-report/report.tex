...
\end{align}
where $P_{\GP}$ must have a corresponding $\mathbb{P}_{\mathcal{G}}$ on some function space $\mathcal{G}$ and we define a general approximation space:
\begin{align}
