...
\end{align}
where there exists a corresponding $\mathbb{P}_{\mathcal{L}^2} \in \mathcal{L}^2(\mathcal{X}, \rho, \mathbb{R})$ for $P_{\GP}$ and we define a general approximation space:
\begin{align}
