...
if __name__ == "__main__":
    ...
    data_csv_path = "experiments/regression/concrete/data/data.csv"
    ...
    data_output_column = "concrete_compressive_strength"
    ...
    if args.action == Actions.build_data.value:
        build_data_set(
            ...
            data_input_columns=data_output_columns,
            data_output_column=data_output_column,
